...
@Component({
  ...
  templateUrl: './tiktok-views.component.html'
})
export class TiktokViewsComponent {
  ...
  addToCart(product: itemCart) {
    if (this.formLink.valid) {
      ...
      this.formLink.reset();
      this.messageService.add({ severity: 'success', summary: 'Súper!', detail: 'Vistas agregados al carrito!', key: 'br', life: 3000 });
    } else {
