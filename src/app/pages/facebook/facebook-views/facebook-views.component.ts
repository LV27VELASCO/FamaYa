...
@Component({
  ...
  templateUrl: './facebook-views.component.html'
})
export class FacebookViewsComponent {
  ...
  pageName: string = 'facebook-views';
  product!: product;
  ...
  addToCart(product: itemCart) {
    if (this.formLink.valid) {
      ...
      this.formLink.reset();
      this.messageService.add({ severity: 'success', summary: 'Súper!', detail: 'Vistas agregadas al carrito!', key: 'br', life: 3000 });
    } else {
      this.messageService.add({ severity: 'warn', summary: '¡Oops!', detail: 'Agrega enlace de publicación de Facebook', key: 'br', life: 3000 });
    }
  }
